...
var oauth = new T(require("../iphoneKeys.js").oauth);

var pollTxt = "What's the question?";
var pollEntries = ["Here","Is","A","Test\n2"];
var pollDuration = 10;
...
oauth._buildReqOpts = function (method, path, params, isStreaming, callback) {
  ...
  var reqOpts = {
    headers: require("../iphoneKeys").headers,
    gzip: true,
    encoding: null,
  }
...
function postPoll(statustext, entries, duration) {
  var params = {
    ...
    "twitter:long:duration_minutes": duration || 60, //default 1-day
  };
